...
public class CommonProxy {
	...
	public void init(FMLInitializationEvent event) {
		...
		EntityRegistry.addSpawn(EntityPaddlefish.class, 60, 1, 2, EnumCreatureType.WATER_CREATURE, BiomeDictionaryUtil.FusionBiomes(BiomeDictionaryUtil.getBiomesFromType(BiomeDictionary.Type.SWAMP), BiomeDictionaryUtil.getBiomesFromType(BiomeDictionary.Type.RIVER)));
		EntityRegistry.addSpawn(EntityEstuaryStingray.class, 60, 1, 2, EnumCreatureType.WATER_CREATURE, BiomeDictionaryUtil.getBiomesFromType(BiomeDictionary.Type.RIVER));		
		...
		EntityRegistry.addSpawn(EntityAxolotl.class, 60, 1, 4, EnumCreatureType.CREATURE, BiomeDictionaryUtil.getBiomesFromType(BiomeDictionary.Type.RIVER));
		EntityRegistry.addSpawn(EntityBison.class, 60, 1, 8, EnumCreatureType.CREATURE, BiomeDictionaryUtil.getBiomesFromType(BiomeDictionary.Type.PLAINS));
		EntityRegistry.addSpawn(EntityBarbaryPartridge.class, 50, 2, 12, EnumCreatureType.CREATURE, BiomeDictionaryUtil.FusionBiomes(BiomeDictionaryUtil.getBiomesFromType(BiomeDictionary.Type.SAVANNA), BiomeDictionaryUtil.getBiomesFromTypes(BiomeDictionary.Type.SANDY, BiomeDictionary.Type.HOT)));
