...
public class EntityRedBilledHornbill extends ZAWABaseFlying {
	
	  private int standNum;
	
	public EntityRedBilledHornbill(World worldIn) {		
		super(worldIn);
	...
	{
	    return SoundHandler.HORNBILL_LIVING;
	}
	
	@Override
	protected SoundEvent getHurtSound(DamageSource s)
	{
	    return SoundHandler.HORNBILL_HURT;
	}
	...
	public EntityAgeable createChild(EntityAgeable ageable) {
		return new EntityRedBilledHornbill(this.world);
	}
