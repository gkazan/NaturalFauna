...
public class ModelCourserFlying extends AdvancedModelBase {
    ...
    public ModelCourserFlying() {
        ...
        this.beak2 = new AdvancedModelRenderer(this, 35, 0);
        ...
        this.head = new AdvancedModelRenderer(this, 12, 17);
        ...
        this.neck2 = new AdvancedModelRenderer(this, 0, 15);
        ...
        this.beak = new AdvancedModelRenderer(this, 35, 10);
        ...
        this.leftwing2 = new AdvancedModelRenderer(this, 0, 23);
        ...
        this.body3 = new AdvancedModelRenderer(this, 24, 21);
