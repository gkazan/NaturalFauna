 ...
 */
public class ModelSaddlebillStorkSit extends ModelBase {
    ...
    public ModelRenderer rfootfingermiddle;
    ...
    public ModelRenderer lffotfingerback;
    ...
    public ModelSaddlebillStorkSit() {
        ...
        this.rfootfingermiddle = new ModelRenderer(this, 9, 26);
        ...
        this.lffotfingerback = new ModelRenderer(this, 16, 26);
