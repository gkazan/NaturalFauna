 ...
 */
public class ModelPuffin extends AdvancedModelBase {
    ...
    public AdvancedModelRenderer peak2;
    ...
    public ModelPuffin() {
        ...
        this.peak = new AdvancedModelRenderer(this, 1, 20);
        ...
        this.peak2 = new AdvancedModelRenderer(this, 11, 20);
        ...
        this.leftwing = new AdvancedModelRenderer(this, 14, 9);
        ...
        this.leftleg = new AdvancedModelRenderer(this, 23, 1);
        ...
        this.leftfoot = new AdvancedModelRenderer(this, 29, 1);
        this.leftfoot.setRotationPoint(0.0F, 2.0F, 1.0F);
        this.leftfoot.addBox(0.0F, 0.0F, -2.0F, 1, 1, 2, 0.0F);
        this.rightwing = new AdvancedModelRenderer(this, 31, 9);
        ...
        this.rightfoot = new AdvancedModelRenderer(this, 11, 1);
