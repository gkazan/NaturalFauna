 ...
 */
public class ModelCheetah extends MowzieModelBase {
    ...
    public MowzieModelRenderer shape4_2;
    public MowzieModelRenderer shape12;
    public MowzieModelRenderer shape4_3;

    public ModelCheetah() {
        this.textureWidth = 64;
        this.textureHeight = 64;
        this.shape7_1 = new MowzieModelRenderer(this, 0, 15);
        this.shape7_1.setRotationPoint(0.0F, -1.5F, -2.3F);
        this.shape7_1.addBox(-3.1F, -2.5F, -5.5F, 6, 5, 5, 0.0F);
        this.shape4_3 = new MowzieModelRenderer(this, 50, 28);
        ...
        this.shape11 = new MowzieModelRenderer(this, 0, 25);
        ...
        this.shape2_2 = new MowzieModelRenderer(this, 30, 34);
        ...
        this.shape4_2 = new MowzieModelRenderer(this, 8, 25);
        ...
        this.shape8_1 = new MowzieModelRenderer(this, 0, 32);
        this.shape8_1.setRotationPoint(2.9F, 4.5F, -1.1F);
        this.shape8_1.addBox(0.0F, 0.0F, 0.0F, 0, 3, 8, 0.0F);
        this.shape2 = new MowzieModelRenderer(this, 50, 0);
        ...
        this.shape4_1 = new MowzieModelRenderer(this, 30, 28);
        ...
        this.shape12 = new MowzieModelRenderer(this, 42, 28);
        ...
        this.shape4 = new MowzieModelRenderer(this, 18, 24);
        ...
        this.shape1 = new MowzieModelRenderer(this, 27, 11);
        ...
        this.shape8 = new MowzieModelRenderer(this, 50, 12);
        ...
        this.shape9_1 = new MowzieModelRenderer(this, 22, 0);
        this.shape9_1.setRotationPoint(1.9F, -3.6F, -2.0F);
        this.shape9_1.addBox(0.0F, 0.0F, 0.0F, 2, 2, 1, 0.0F);
        this.shape2_1 = new MowzieModelRenderer(this, 30, 10);
        ...
        this.shape6 = new MowzieModelRenderer(this, 30, 0);
