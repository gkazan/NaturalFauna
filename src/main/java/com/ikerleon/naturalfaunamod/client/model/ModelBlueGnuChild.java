...
public class ModelBlueGnuChild extends BookwormModelBase {
    ...
    public ModelBlueGnuChild() {
        ...
        this.crest = new BookwormModelRenderer(this, 0, 42, "crest");
        this.crest.setRotationPoint(-0.3F, -4.0F, -8.3F);
        this.crest.addBox(0.0F, 0.0F, 0.0F, 1, 1, 8, 0.0F);
        this.frontrightleg2 = new BookwormModelRenderer(this, 0, 4, "frontrightleg2");
        ...
        this.backrightleg3 = new BookwormModelRenderer(this, 0, 4, "backrightleg3");
        ...
        this.backleftleg3 = new BookwormModelRenderer(this, 0, 4, "backleftleg3");
        ...
        this.frontleftleg2 = new BookwormModelRenderer(this, 0, 5, "frontleftleg2");
