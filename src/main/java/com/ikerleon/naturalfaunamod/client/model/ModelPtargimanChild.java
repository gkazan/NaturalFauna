...
public class ModelPtargimanChild extends BookwormModelBase {
    ...
    public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity entity) 
    {
        ...
        this.leftleg.rotateAngleX = 1F * f1 * (0.25f * globalDegree) * MathHelper.cos(f * (1.5f * globalSpeed) + 0) + 0.31869712141416456F;
        this.rightleg.rotateAngleX = -1F * f1 * (0.25f * globalDegree) * MathHelper.cos(f * (1.5f * globalSpeed) + 0) + 0.31869712141416456F;
        this.head.rotateAngleX = 1F * f1 * (0.25f * globalDegree) * MathHelper.cos(f * (1f * globalSpeed) + 0) + 0.40980330836826856F;

        this.head.rotateAngleX = 1F * 0.5F * (0.08f) * MathHelper.cos(entity.ticksExisted * (0.17f) + 2.5f) + 0.40980330836826856F;
        this.leftwing.rotateAngleX = -1F * 0.5F * (0.04f) * MathHelper.cos(entity.ticksExisted * (0.17f) + 2.5f) + -0.045553093477052F;
        this.rightwing.rotateAngleX = -1F * 0.5F * (0.04f) * MathHelper.cos(entity.ticksExisted * (0.17f) + 2.5f) + -0.045553093477052F;
    }
}
