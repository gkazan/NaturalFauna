...
public class ModelCourser extends ModelBase {
    ...
    public ModelRenderer cuello1;
    public ModelRenderer cuello3;
    public ModelRenderer cuello2;
    public ModelRenderer pata1izq;
    public ModelRenderer cuerpo;
    public ModelRenderer alaizq;
    public ModelRenderer cola;
    public ModelRenderer cabeza;
    public ModelRenderer pata1der;
    public ModelRenderer alader;
    public ModelRenderer pata1izqChild;
    public ModelRenderer pata1izqChildChild;
    public ModelRenderer cabezaChild;
    public ModelRenderer cabezaChild_1;
    public ModelRenderer pata1derChild;
    public ModelRenderer pata1derChildChild;

    public ModelCourser() {
        this.textureWidth = 64;
        this.textureHeight = 32;
        this.pata1izqChild = new ModelRenderer(this, 17, 22);
        ...
        this.cuerpo = new ModelRenderer(this, 36, 22);
        ...
        this.cuello1 = new ModelRenderer(this, 53, 17);
        ...
        this.cuello2 = new ModelRenderer(this, 55, 11);
        ...
        this.pata1izq = new ModelRenderer(this, 17, 17);
        ...
        this.cola = new ModelRenderer(this, 36, 11);
        ...
        this.alader = new ModelRenderer(this, 23, 12);
        ...
        this.pata1derChild = new ModelRenderer(this, 10, 22);
        ...
        this.pata1izqChildChild = new ModelRenderer(this, 16, 27);
        ...
        this.cuerpo2 = new ModelRenderer(this, 36, 15);
        ...
        this.alaizq = new ModelRenderer(this, 23, 22);
        ...
        this.cabezaChild = new ModelRenderer(this, 50, 3);
        ...
        this.pata1derChildChild = new ModelRenderer(this, 9, 27);
        ...
        this.cabezaChild_1 = new ModelRenderer(this, 50, 1);
        ...
        this.cuello3 = new ModelRenderer(this, 58, 6);
