 ...
 */
public class ModelPeregrineFalconChild extends AdvancedModelBase {
    ...
    public ModelPeregrineFalconChild() {
        ...
        this.leftwing = new AdvancedModelRenderer(this, 24, 1);
        ...
        this.rightwing = new AdvancedModelRenderer(this, 40, 1);
