...
public class ModelBlueGnu extends ModelBase {
    ...
    public ModelBlueGnu() {
        ...
        this.shape2_3.setRotationPoint(6.1F, 4.5F, 14.8F);
        this.shape2_3.addBox(0.0F, 0.0F, 0.0F, 2, 13, 2, 0.0F);
        ...
        this.shape9.setRotationPoint(-0.6F, -0.1F, -2.0F);
        this.shape9.addBox(0.0F, 0.0F, 0.0F, 6, 7, 4, 0.0F);
        this.shape13 = new ModelRenderer(this, 49, 0);
        this.shape13.setRotationPoint(3.0F, 1.3F, 15.6F);
        this.shape13.addBox(0.0F, 0.0F, 0.0F, 2, 4, 2, 0.0F);
        this.setRotateAngle(shape13, 0.18203784098300857F, 0.0F, 0.0F);
        this.shape14 = new ModelRenderer(this, 39, 42);
        this.shape14.setRotationPoint(-0.5F, 2.2F, -0.7F);
        this.shape14.addBox(0.0F, 0.0F, 0.0F, 3, 11, 3, 0.0F);
        this.setRotateAngle(shape14, -0.091106186954104F, 0.0F, 0.0F);
        this.shape15 = new ModelRenderer(this, 49, 12);
        this.shape15.setRotationPoint(-1.9F, 1.6F, 2.9F);
        this.shape15.addBox(0.0F, 0.0F, 0.0F, 3, 2, 1, 0.0F);
        this.setRotateAngle(shape15, 0.0F, 0.0F, 0.22759093446006054F);
        this.shape15_3 = new ModelRenderer(this, 49, 6);
        this.shape15_3.setRotationPoint(5.8F, 2.8F, 2.1F);
        ...
        this.shape8.setRotationPoint(1.3F, 0.3F, -6.7F);
        this.shape8.addBox(0.0F, 0.0F, 0.0F, 5, 7, 9, 0.0F);
        this.shape15_1 = new ModelRenderer(this, 50, 15);
        this.shape15_1.setRotationPoint(5.4F, 2.3F, 2.7F);
        this.shape15_1.addBox(0.0F, 0.0F, 0.0F, 3, 2, 1, 0.0F);
        this.setRotateAngle(shape15_1, 0.0F, 0.0F, -0.22759093446006054F);
        this.shape11 = new ModelRenderer(this, 37, 26);
        this.shape11.setRotationPoint(2.1F, -3.4F, 0.0F);
        this.shape11.addBox(0.0F, 0.0F, 0.0F, 1, 5, 11, 0.0F);
        this.shape15_2 = new ModelRenderer(this, 50, 18);
        this.shape15_2.setRotationPoint(-0.1F, 1.9F, 5.0F);
        ...
        this.shape2_2.setRotationPoint(-0.1F, 4.5F, 14.8F);
        this.shape2_2.addBox(0.0F, 0.0F, 0.0F, 2, 13, 2, 0.0F);
        this.shape2 = new ModelRenderer(this, 0, 0);
        this.shape2.setRotationPoint(-0.1F, 4.5F, 0.6F);
        this.shape2.addBox(0.0F, 0.0F, 0.0F, 2, 13, 2, 0.0F);
        this.shape11_1 = new ModelRenderer(this, 19, 37);
        this.shape11_1.setRotationPoint(2.0F, 5.4F, -0.3F);
        ...
        this.shape10.setRotationPoint(1.6F, 1.6F, -0.3F);
        ...
        this.shape15_6.setRotationPoint(1.3F, -2.7F, 2.0F);
        ...
        this.shape2_1.setRotationPoint(6.1F, 4.5F, 0.5F);
        this.shape2_1.addBox(0.0F, 0.0F, 0.0F, 2, 13, 2, 0.0F);
