...
public class ModelBlueGnu extends ModelBase {
    ...
    public ModelBlueGnu() {
        ...
        this.body3.setRotationPoint(0.5F, 0.0F, 6.5F);
        ...
        this.body2.setRotationPoint(0.5F, 0.5F, 7.0F);
        ...
        this.backleftleg.setRotationPoint(3.5F, 3.5F, 6.9F);
        ...
        this.backrightleg.setRotationPoint(0.4F, 3.5F, 6.9F);
        ...
        this.cresttop = new ModelRenderer(this, 37, 26);
        this.cresttop.setRotationPoint(-0.3F, -6.4F, -8.8F);
        this.cresttop.addBox(0.0F, 0.0F, 0.0F, 1, 5, 11, 0.0F);
        ...
        this.neck.addChild(this.cresttop);
