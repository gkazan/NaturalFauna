...
public class ModelOstrich extends ModelBase {
    ...
    public ModelOstrich() {
        ...
        this.shape21.setRotationPoint(4.5F, 7.5F, 4.0F);
        ...
        this.shape15_1.setRotationPoint(1.8F, 13.8F, -1.7F);
        ...
        this.shape2_1.setRotationPoint(0.5F, -2.5F, 1.3F);
        this.shape2_1.addBox(0.0F, 0.0F, 0.0F, 2, 15, 2, 0.0F);
        ...
        this.shape11.setRotationPoint(0.5F, 1.4F, -1.7F);
        ...
        this.shape15.setRotationPoint(1.1F, 14.1F, -2.1F);
        this.shape15.addBox(0.0F, 0.0F, 0.0F, 1, 1, 3, 0.0F);
        this.shape14 = new ModelRenderer(this, 40, 0);
        this.shape14.setRotationPoint(-0.5F, 14.1F, -1.6F);
        ...
        this.shape19.setRotationPoint(2.0F, 6.0F, -3.5F);
        this.shape19.addBox(0.0F, 0.0F, 0.0F, 4, 5, 5, 0.0F);
        this.setRotateAngle(shape19, 1.730144887501979F, 0.0F, 0.0F);
        this.shape7 = new ModelRenderer(this, 34, 17);
        this.shape7.setRotationPoint(-0.5F, -3.5F, -0.3F);
        this.shape7.addBox(0.0F, 0.0F, 0.0F, 4, 3, 4, 0.0F);
        ...
        this.shape13.setRotationPoint(1.5F, 2.1F, 8.8F);
        this.shape13.addBox(-0.0F, -2.0F, 0.7F, 5, 5, 7, 0.0F);
        ...
        this.shape5.setRotationPoint(0.5F, -1.2F, 11.7F);
        this.shape5.addBox(0.0F, -1.8F, 0.5F, 3, 11, 3, 0.0F);
        this.setRotateAngle(shape5, -1.5025539530419183F, 0.0F, 0.0F);
        this.shape14_1 = new ModelRenderer(this, 40, 0);
        this.shape14_1.setRotationPoint(0.1F, 13.9F, -2.0F);
        this.shape14_1.addBox(0.0F, 0.0F, 0.0F, 1, 1, 3, 0.0F);
